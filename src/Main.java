...
public class Main extends JFrame {
    ...
    private final String[] colors = {"Red", "Blue ", "Black", "Pink", "Brown", "Purple"};    //final عشان تبقا الوان ثابته متتغيرش
    private final String[] secretCode = new String[4];        //عدد الالوان اللي المفروض هختار منها
    private int attemptsLeft = 5;       // عدد المحاولات

    // GUI components   مكونات البرنامج اي
    private ArrayList<JComboBox<String>> guessComboBoxes = new ArrayList<>();// الاربع مربعات اللي اللاعب بيخمن فيهم
    private JButton submitButton;         //زرار الارسال
    private JTextArea feedbackArea;//الجزء ال بيظهر فيه اي ال اخترته صح او غلط
    private JPanel feedbackPanel; // المستطيل ال حاوي كل حاجه
    private JPanel colorDisplayPanel; // بتظهرلي الالوان اللي هخمن منها
    private JLabel attemptsLabel; //عدد المحاولات المتبقيه
    private JButton resetButton;//لو خلصت عدد المحولات وهعيد من الاول

    public Main() {
        // Set up JFrame properties
        setTitle("Mastermind Game"); //عنوان اللعبه
        setSize(700, 800);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new FlowLayout(FlowLayout.CENTER, 20, 20)); // موقع الازرار
        setLocationRelativeTo(null);//  هيبقا برا الويندو مكان مهتظهر فين
        ...
        resetButton.setBackground(new Color(172, 100, 255));
